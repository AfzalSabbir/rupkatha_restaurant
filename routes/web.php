...
Route::group(['prefix' => 'admin'], function(){
	...
	*/
    ...
    Route::group(['prefix' => 'sale'], function(){
    	...
    	Route::get('/bill', 'Backend\SaleController@bill');


        /**
         * Cart Route
         */
        Route::get('/all-cart-item', 'Backend\SaleController@getCartItem');
        Route::post('/update_cart_qty', 'Backend\SaleController@updateCart');
        Route::post('/update_cart_price', 'Backend\SaleController@updateCartPrice');
        Route::post('/delete-from-cart', 'Backend\SaleController@deleteFromCart');
